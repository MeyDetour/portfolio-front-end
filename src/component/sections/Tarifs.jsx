...
<div className="flexColEvenly alignCenter tarifContainer h100p">
    ...
    <div className="flexRowCenter h50p">
        <div className="flexCol w25p alignCenter mr-3">
            <h2 >Situation 1</h2>
            <p>Vous diposez déjà d’une maquette en rapport avec votre projet et souhaitez la faire développer !</p>
        </div>
        ...
        <div className="flexCol w25p alignCenter ml-3">
            <h2>Situation 2</h2>
           <p>Vous n’avez toujours pas de maquette de votre site internet et souhaitez en avoir une en plus de la faire développer !</p>
             </div>
    </div>
</div>
    </>
